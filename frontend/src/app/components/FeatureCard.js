                ...
                >
                    ...
                    <div className='p-3 sm:p-4'>
                        ...
                        <div className='flex items-center justify-between'>
                            <h1 className='text-sm font-bold sm:text-base'>${property.price} <span className='text-xs font-normal sm:text-sm'>/night</span></h1>
                            <div className='flex items-center'>
                                <CiStar className='text-[#DC2626]' />
                                <h1 className='ml-1 text-sm font-bold'>{property.rating}</h1>
                                <p className='ml-1 text-xs text-gray-600 sm:text-sm sm:ml-2'>({property.reviewsCount})</p>
                            </div>
                        </div>
                    </div>
                </div>
